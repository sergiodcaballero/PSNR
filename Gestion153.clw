   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('GESTION153.INC'),ONCE        !Local module procedure declarations
                       INCLUDE('GESTION149.INC'),ONCE        !Req'd for module callout resolution
                       INCLUDE('GESTION150.INC'),ONCE        !Req'd for module callout resolution
                     END
