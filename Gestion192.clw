   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('GESTION192.INC'),ONCE        !Local module procedure declarations
                       INCLUDE('GESTION176.INC'),ONCE        !Req'd for module callout resolution
                       INCLUDE('GESTION191.INC'),ONCE        !Req'd for module callout resolution
                       INCLUDE('GESTION193.INC'),ONCE        !Req'd for module callout resolution
                     END
