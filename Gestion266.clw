   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('GESTION266.INC'),ONCE        !Local module procedure declarations
                       INCLUDE('GESTION265.INC'),ONCE        !Req'd for module callout resolution
                     END
