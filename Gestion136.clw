   ...
   INCLUDE('ABWINDOW.INC'),ONCE
                     ...
                     MAP
                       INCLUDE('GESTION136.INC'),ONCE        !Local module procedure declarations
                       INCLUDE('GESTION135.INC'),ONCE        !Req'd for module callout resolution
                     END
